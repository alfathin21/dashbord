...
<form action="graph_component.php" method="post" class="form-horizontal style-form" style="margin-bottom: 50px">
...
<input type="submit" value="Display Pareto" class="btn btn-default">
</form>

<script>
$( function() {
  $( ".datepicker" ).datepicker({
      dateFormat: "dd/mm/yy", //Seharusnya inputnya gini, tapi waktu di STRTOTIME, dia kebalik bedain tanggal sama bulan, jadi waktu passing variable, tanggal sama bulan dibalik
      changeYear: true,
      changeMonth: true
  });
});
