...
<form method="post" style="margin-bottom: 50px" id="form_mtbur" class="form-horizontal style-form" name="form_mtbur" onsubmit="return validateForm()">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<?php
				echo '<input name="monthfrom" class="form-control" id="id_monthfrom" value="'.$_POST["monthfrom"].'">';	 
			?>
		</div>
		<label class="col-xs-6 col-sm-2 control-label">Month to</label>
		<div class="col-sm-3">
			<?php
				echo '<input name="monthto" class="form-control" id="id_monthto" value="'.$_POST["monthto"].'">'; 
			?>
		</div>
	</div>
